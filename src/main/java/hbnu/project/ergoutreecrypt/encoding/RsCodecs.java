 ...
 *
 * <p>命名 RSn 表示 n 个数据字节编码为相应总字节数（除 RS128 为 n→n+8 外，其余为 n→n*3）。
 * 各规格用途见字段注释。所有编解码器仅在启动时创建一次并全程复用。
 *
 * @author ErgouTree
 */
